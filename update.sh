...
awk \
	...
	-v "TIDEWAYS_CLI_SHA256_X64=$(curl -fsSL "https://tideways.s3.amazonaws.com/cli/${TIDEWAYS_CLI_VERSION}/tideways-cli_linux_amd64-${TIDEWAYS_CLI_VERSION}.tar.gz" |sha256sum |cut -d' ' -f1)" \
